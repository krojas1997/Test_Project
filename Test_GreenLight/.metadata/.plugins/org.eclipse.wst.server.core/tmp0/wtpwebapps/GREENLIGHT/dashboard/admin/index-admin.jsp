      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMulti">
            <li>
              <a href="pages/MantPacientes.jsp">Pacientes</a>
            </li>
            <li>
              <a href="pages/MantPersonal.jsp">Personal</a>
            </li>
            <li>
              <a href="pages/MantEspecia.jsp">Especialidades</a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMulti1">
            <li>
              <a href="pages/HistMed.jsp">Historiales Medicos</a>
            </li>
            <li>
              <a href="pages/HistCit.jsp">Historiales de Citas</a>
            </li>
          </ul>
        </li>
